...
export class PokeGenComponent implements OnInit {
  ...
  animals: Animal[] = [
    ...
    {
      name: "Ape",
      desc: "Apes are a branch of Old World tailless simians native to Africa and Southeast Asia. They are the sister group of the Old World monkeys, together forming the catarrhine clade. They are distinguished from other primates by a wider degree of freedom of motion at the shoulder joint as evolved by the influence of brachiation. In traditional and non-scientific use, the term 'ape' excludes humans, and is thus not equivalent to the scientific taxon Hominoidea. There are two extant branches of the superfamily Hominoidea: the gibbons, or lesser apes; and the hominids, or great apes.",
    ...
    {
      name: "Donkey",
      desc: "The donkey or ass  is a domesticated member of the horse family, Equidae. The wild ancestor of the donkey is the African wild ass, E. africanus. The donkey has been used as a working animal for at least 5000 years. There are more than 40 million donkeys in the world, mostly in underdeveloped countries, where they are used principally as draught or pack animals. Working donkeys are often associated with those living at or below subsistence levels. Small numbers of donkeys are kept for breeding or as pets in developed countries.",
    ...
    {
      name: "Bat",
      desc: "Bats are mammals of the order Chiroptera with their forelimbs adapted as wings, they are the only mammals naturally capable of true and sustained flight. Bats are more manoeuvrable than birds, flying with their very long spread-out digits covered with a thin membrane or patagium. The smallest bat, and arguably the smallest extant mammal, is Kitti's hog-nosed bat, which is 29-34mm in length, 15cm across the wings and 2-2.6g in mass. The largest bats are the flying foxes and the giant golden-crowned flying fox, Acerodon jubatus, which can weigh 1.6kg and have a wingspan of 1.7m.",
    ...
    {
      name: "Binturong",
      desc: "The binturong , also known as bearcat, is a viverrid native to South and Southeast Asia. It is uncommon in much of its range, and has been assessed as Vulnerable on the IUCN Red List because of a declining population trend that is estimated at more than 30% over the last three decades.;",
    ...
    {
      name: "Buffalo",
      desc: "The African buffalo or Cape buffalo is a large Sub-Saharan African bovine.; Syncerus caffer caffer, the Cape buffalo, is the typical subspecies, and the largest one, found in Southern and East Africa. S. c. nanus is the smallest subspecies, common in forest areas of Central and West Africa, while S. c. brachyceros is in West Africa and S. c. aequinoctialis is in the savannas of East Africa. The adult buffalo's horns are its characteristic feature: they have fused bases, forming a continuous bone shield across the top of the head referred to as a 'boss'. They are widely regarded as among the most dangerous animals on the African continent, and according to some estimates they gore, trample, and kill over 200 people every year.",
    ...
    {
      name: "Caracal",
      desc: "The caracal /'kær?kæl/ is a medium-sized wild cat native to Africa, the Middle East, Central Asia, and India. It is characterised by a robust build, long legs, a short face, long tufted ears, and long canine teeth. Its coat is uniformly reddish tan or sandy, while the ventral parts are lighter with small reddish markings. It reaches 40-50cm at the shoulder and weighs 8-18kg. It was first scientifically described by German naturalist Johann Christian Daniel von Schreber in 1776. Three subspecies are recognised since 2017.",
    ...
    {
      name: "Cassowary",
      desc: "Cassowaries , genus Casuarius, are ratites that are native to the tropical forests of New Guinea , East Nusa Tenggara, the Maluku Islands, and northeastern Australia.;",
    ...
    {
      name: "Chameleon",
      desc: "Chameleons or chamaeleons are a distinctive and highly specialized clade of Old World lizards with 202 species described as of June 2015.; These species come in a range of colors, and many species have the ability to change color.",
    ...
    {
      name: "Coati",
      desc: "Coatis, also known as coatimundis , are members of the family in the genera Nasua and Nasuella. They are diurnal mammals native to South America, Central America, and the southwestern United States. The name coatimundi is purportedly derived from the Tupian languages of Brazil.;",
    ...
    {
      name: "Cobra",
      desc: "Cobra is the common name of various elapid snakes, most of which belonging to the genus Naja.;",
    ...
    },
    {
      ...
      url: "https://en.wikipedia.org/wiki/Crane_",
    ...
    {
      name: "Curlew",
      desc: "The curlews , genus Numenius, are a group of eight species of birds, characterised by long, slender, downcurved bills and mottled brown plumage. The English name is imitative of the Eurasian curlew's call, but may have been influenced by the Old French corliu, 'messenger', from courir , 'to run'. It was first recorded in 1377 in Langland's Piers Plowman 'Fissch to lyue in _e flode.._e corlue by kynde of _e eyre'.; In Europe 'curlew' usually refers to one species, the Eurasian curlew Numenius arquata.",
    ...
    {
      name: "Dolphin",
      desc: "Dolphin is a common name of aquatic mammals within the infraorder Cetacea. The term dolphin usually refers to the extant families Delphinidae , Platanistidae , Iniidae , and Pontoporiidae , and the extinct Lipotidae. There are 40 extant species named as dolphins.",
    ...
    {
      name: "Dotterel",
      desc: "The Eurasian dotterel , also known in Europe as just dotterel, is a small wader in the plover family of birds.",
    ...
    {
      name: "Eel",
      desc: "An eel is any ray-finned fish belonging to the order Anguilliformes , which consists of four suborders, 20 families, 111 genera, and about 800 species. Eels undergo considerable development from the early larval stage to the eventual adult stage, and most are predators.",
    ...
    {
      name: "Elephant seal",
      desc: "Elephant seals are large, oceangoing earless seals in the genus Mirounga. The two species, the northern elephant seal and the southern elephant seal , were both hunted to the brink of extinction by the end of the 19th century, but their numbers have since recovered.",
    ...
    {
      name: "Falcon",
      desc: "Falcons are birds of prey in the genus Falco, which includes about 40 species. Falcons are widely distributed on all continents of the world except Antarctica, though closely related raptors did occur there in the Eocene.;",
    ...
    {
      name: "Ferret",
      desc: "The ferret is the domesticated form of the European polecat, a mammal belonging to the same genus as the weasel, Mustela, in the family Mustelidae.; Their fur is typically brown, black, white, or mixed. They have an average length of 51cm , including a 13cm tail, weigh about 1.5-4 pounds , and have a natural lifespan of 7 to 10years.; Ferrets are sexually dimorphic predators, with males being substantially larger than females.",
    ...
    {
      name: "Flamingo",
      desc: "Flamingos or flamingoes; /fl?'m??go?z/ are a type of wading bird in the family Phoenicopteridae, the only bird family in the order Phoenicopteriformes. Four flamingo species are distributed throughout the Americas, including the Caribbean, and two species are native to Africa, Asia, and Europe.",
    ...
    {
      name: "Fly",
      desc: "Flies are insects with a pair of functional wings for flight and a pair of specialized hindwings called halteres for balance. They are classified as an order called Diptera, that name being derived from the Greek δ?- di- 'two', and πτε??? pteron 'wings'. The order Diptera is divided into two suborders , with about 110 families divided between them; the families contain an estimated 1,000,000 species, including the familiar housefly, horse-fly, crane fly, and hoverfly although only about 125,000 species have a species description published.; The earliest fly fossils found so far are from the Triassic, about 240 million years ago; phylogenetic analysis suggests that flies originated in the Permian, about 260 million years ago.",
    ...
    {
      name: "Fox",
      desc: "Foxes are small-to-medium-sized, omnivorous mammals belonging to several genera of the family Canidae. Foxes have a flattened skull, upright triangular ears, a pointed, slightly upturned snout, and a long bushy tail.",
    ...
    {
      name: "Gaur",
      desc: "The gaur , also called the Indian bison, is the largest extant bovine. It is native to South and Southeast Asia and has been listed as Vulnerable on the IUCN Red List since 1986. The global population has been estimated at maximum 21,000 mature individuals by 2016. It declined by more than 70% during the last three generations, and is extinct in Sri Lanka and probably also in Bangladesh. In well-protected areas, it is stable and rebuilding in a few areas.;",
    ...
    {
      name: "Gecko",
      desc: "Geckos are lizards belonging to the infraorder Gekkota, found in warm climates throughout the world. They range from 1.6 to 60cm. Most geckos cannot blink, but they often lick their eyes to keep them clean and moist. They have a fixed lens within each iris that enlarges in darkness to let in more light.",
    ...
    {
      name: "Goat",
      desc: "The domestic goat or simply goat is a subspecies of C. aegagrus domesticated from the wild goat of Southwest Asia and Eastern Europe. The goat is a member of the animal family Bovidae and the subfamily Caprinae, meaning it is closely related to the sheep. There are over 300 distinct breeds of goat.; Goats are one of the oldest domesticated species of animal, and have been used for milk, meat, fur and skins across much of the world.; Milk from goats is often turned into goat cheese.",
    ...
    {
      name: "Goldfinch",
      desc: "The European goldfinch or goldfinch , is a small passerine bird in the finch family that is native to Europe, North Africa and western Asia. It has been introduced to other areas including Australia, New Zealand and Uruguay.",
    ...
    {
      name: "Goosander",
      desc: "The common merganser or goosander  is a large duck of rivers and lakes in forested areas of Europe, northern and central Asia, and North America.",
    ...
    {
      name: "Gorilla",
      desc: "Gorillas are ground-dwelling, predominantly herbivorous apes that inhabit the forests of central Sub-Saharan Africa. The genus Gorilla is divided into two species: the eastern gorillas and the western gorillas , and either four or five subspecies. They are the largest living primates. The DNA of gorillas is highly similar to that of humans, from 95 to 99% depending on what is included, and they are the next closest living relatives to humans after the chimpanzees and bonobos.",
    ...
    {
      name: "Guanaco",
      desc: "The guanaco ; is a camelid native to South America, closely related to the llama. Its name comes from the Quechua word huanaco;. Young guanacos are called chulengos.;",
    ...
    {
      name: "Hamster",
      desc: "Hamsters are rodents belonging to the subfamily Cricetinae, which contains 18 species classified in seven genera. They have become established as popular small house pets.; The best-known species of hamster is the golden or Syrian hamster , which is the type most commonly kept as pets. Other hamster species commonly kept as pets are the three species of dwarf hamster, Campbell's dwarf hamster , the winter white dwarf hamster and the Roborovski hamster.",
    ...
    {
      name: "Hermit crab",
      desc: "Hermit crabs are decapod crustaceans of the superfamily Paguroidea.",
    ...
    {
      name: "Hoatzin",
      desc: "The hoatzin , also known as the reptile bird, skunk bird, stinkbird, or Canje pheasant, is a species of tropical bird found in swamps, riparian forests, and mangroves of the Amazon and the Orinoco basins in South America. It is notable for having chicks that have claws on two of their wing digits.",
    ...
    {
      name: "Hoopoe",
      desc: "Hoopoes are colourful birds found across Afro-Eurasia, notable for their distinctive 'crown' of feathers. Three living and one extinct species are recognized, though for many years all were lumped as a single species-Upupa epops.",
    ...
    {
      name: "Horse",
      desc: "The horse  is one of two extant subspecies of Equus ferus. It is an odd-toed ungulate mammal belonging to the taxonomic family Equidae. The horse has evolved over the past 45 to 55million years from a small multi-toed creature, Eohippus, into the large, single-toed animal of today. Humans began domesticating horses around 4000 BC, and their domestication is believed to have been widespread by 3000 BC. Horses in the subspecies caballus are domesticated, although some domesticated populations live in the wild as feral horses. These feral populations are not true wild horses, as this term is used to describe horses that have never been domesticated, such as the endangered Przewalski's horse, a separate subspecies, and the only remaining true wild horse. There is an extensive, specialized vocabulary used to describe equine-related concepts, covering everything from anatomy to life stages, size, colors, markings, breeds, locomotion, and behavior.",
    ...
    {
      name: "Hummingbird",
      desc: "Hummingbirds are birds native to the Americas and constitute the biological family Trochilidae. They are the smallest of birds, most species measuring 7.5-13cm in length. The smallest extant bird species is the 5cm bee hummingbird, which weighs less than 2.0g.",
    ...
    {
      name: "Ibex",
      desc: "An ibex is any of several species of wild mountain goat , distinguished by the male's large recurved horns, which are transversely ridged in front. Ibex are found in Eurasia, North Africa, and East Africa. The name ibex comes from Latin, borrowed from Iberian or Aquitanian, akin to Old Spanish bezerro 'bull', modern Spanish becerro 'yearling'. Ranging in height from 27 to 43 inches and weighing 200 to 270 pounds , the ibex can live 20 years. Two closely related species of wild goats are not usually called ibex: the markhor and the wild goat.",
    ...
    {
      name: "Impala",
      desc: "The impala is a medium-sized antelope found in eastern and southern Africa. The sole member of the genus Aepyceros, it was first described to European audiences by German zoologist Hinrich Lichtenstein in 1812. Two subspecies are recognised-the common impala, and the larger and darker black-faced impala. The impala reaches 70-92 centimetres at the shoulder and weighs 40-76kg. It features a glossy, reddish brown coat. The male's slender, lyre-shaped horns are 45-92 centimetres long.",
    ...
    {
      name: "Jaguar",
      desc: "The jaguar is a large felid species and the only extant member of the genus Panthera native to the Americas. The jaguar's present range extends from Southwestern United States and Mexico in North America, across much of Central America, and south to Paraguay and northern Argentina in South America. Though there are single cats now living within the Western United States, the species has largely been extirpated from the United States since the early 20th century. It is listed as Near Threatened on the IUCN Red List; and its numbers are declining. Threats include loss and fragmentation of habitat.",
    ...
    {
      name: "Jerboa",
      desc: "Jerboas form the bulk of the membership of the family Dipodidae. Jerboas are hopping desert rodents found throughout Arabia, Northern Africa and Asia.; They tend to live in hot deserts.;",
    ...
    {
      name: "Koala",
      desc: "The koala is an arboreal herbivorous marsupial native to Australia. It is the only extant representative of the family Phascolarctidae and its closest living relatives are the wombats, which comprise the family Vombatidae. The koala is found in coastal areas of the mainland's eastern and southern regions, inhabiting Queensland, New South Wales, Victoria, and South Australia. It is easily recognisable by its stout, tailless body and large head with round, fluffy ears and large, spoon-shaped nose. The koala has a body length of 60-85cm and weighs 4-15kg. Pelage colour ranges from silver grey to chocolate brown. Koalas from the northern populations are typically smaller and lighter in colour than their counterparts further south. These populations possibly are separate subspecies, but this is disputed.",
    ...
    {
      name: "Kookaburra",
      desc: "Kookaburras are terrestrial tree kingfishers of the genus Dacelo native to Australia and New Guinea, which grow to between 28-42cm in length. The name is a loanword from Wiradjuri guuguubarra, onomatopoeic of its call. The loud distinctive call of the laughing kookaburra is widely used as a stock sound effect in situations that involve an Australian bush setting or tropical jungle, especially in older movies.",
    ...
    {
      name: "Kouprey",
      desc: "The kouprey is a little-known, forest-dwelling, wild bovine species from Southeast Asia. A young male was sent to the Vincennes Zoo in 1937 where it was described by the French zoologist Achille Urbain and was declared the holotype. The kouprey has a tall, narrow body, long legs, a humped back and long horns.",
    ...
    {
      name: "Lemur",
      desc: "Lemurs LEE-m?r) are mammals of the order Primates, divided into 8 families and consisting of 15 genera and around 100 existing species. They are native only to the island of Madagascar. Most existing lemurs are small, have a pointed snout, large eyes, and a long tail. They chiefly live in trees , and are active at night.",
    ...
    {
      name: "Lizard",
      desc: "Lizards are a widespread group of squamate reptiles, with over 6,000 species,; ranging across all continents except Antarctica, as well as most oceanic island chains. The group is paraphyletic as it excludes the snakes and Amphisbaenia; some lizards are more closely related to these two excluded groups than they are to other lizards. Lizards range in size from chameleons and geckos a few centimeters long to the 3 meter long Komodo dragon.",
    ...
    {
      name: "Llama",
      desc: "The llama  is a domesticated South American camelid, widely used as a meat and pack animal by Andean cultures since the Pre-Columbian era.",
    ...
    {
      name: "Lobster",
      desc: "Lobsters are a family of large marine crustaceans.",
    ...
    {
      name: "Loris",
      desc: "Loris is the common name for the strepsirrhine primates of the subfamily Lorinae; in the family Lorisidae. Loris is one genus in this subfamily and includes the slender lorises, while Nycticebus is the genus containing the slow lorises.",
    ...
    {
      name: "Louse",
      desc: "Louse is the common name for members of the order Phthiraptera, which contains nearly 5,000 species of wingless insect. Lice are obligate parasites, living externally on warm-blooded hosts which include every species of bird and mammal, except for monotremes, pangolins, and bats. Lice are vectors of diseases such as typhus.",
    ...
    {
      name: "Lynx",
      desc: "A lynx is any of the four species within the medium-sized wild cat genus Lynx. The name lynx originated in Middle English via Latin from the Greek word ????,; derived from the Indo-European root leuk- ; in reference to the luminescence of its reflective eyes.;",
    ...
    {
      name: "Macaw",
      desc: "Macaws are long-tailed, often colorful New World parrots.;",
    ...
    {
      name: "Mandrill",
      desc: "The mandrill is a primate of the Old World monkey family.; It is one of two species assigned to the genus Mandrillus, along with the drill. Both the mandrill and the drill were once classified as baboons in the genus Papio, but they now have their own genus, Mandrillus.; Although they look superficially like baboons, they are more closely related to Cercocebus mangabeys. Mandrills are found in southern Cameroon, Gabon, Equatorial Guinea, and Congo. Mandrills mostly live in tropical rainforests. They live in very large groups. Mandrills have an omnivorous diet consisting mostly of fruits and insects. Their mating season peaks in July to September, with a corresponding birth peak in December to April.",
    ...
    {
      name: "Meerkat",
      desc: "The meerkat or suricate is a small carnivoran belonging to the mongoose family. It is the only member of the genus Suricata.; Meerkats live in all parts of the Kalahari Desert in Botswana, in much of the Namib Desert in Namibia and southwestern Angola, and in South Africa. A group of meerkats is called a 'mob', 'gang' or 'clan'. A meerkat clan often contains about 20 meerkats, but some super-families have 50 or more members. In captivity, meerkats have an average life span of 12-14 years, and about half this in the wild.",
    ...
    {
      name: "Mole",
      desc: "Moles are small mammals adapted to a subterranean lifestyle. They have cylindrical bodies; velvety fur; very small, inconspicuous ears and eyes reduced hindlimbs; and short, powerful forelimbs with large paws adapted for digging.",
      url: "https://en.wikipedia.org/wiki/Mole_",
      imgUrl: "//upload.wikimedia.org/wikipedia/commons/thumb/4/44/Kret_mole.jpg/220px-Kret_mole.jpg"
    },
    {
      name: "Mongoose",
      desc: "Mongoose is the popular English name for 29 of the 34; species in the 14 genera of the family Herpestidae, which are small feliform carnivorans native to southern Eurasia and mainland Africa. The other five species in the family are the four kusimanses in the genus Crossarchus, and the species Suricata suricatta, commonly called meerkat in English.",
    ...
    {
      name: "Monkey",
      desc: "Monkey is a common name that may refer to groups or species of mammals, in part, the simians of infraorder Simiiformes. The term is applied descriptively to groups of primates, such as families of new world monkeys and old world monkeys. Many monkey species are tree-dwelling , although there are species that live primarily on the ground, such as baboons. Most species are also active during the day. Monkeys are generally considered to be intelligent, especially the old world monkeys of Catarrhini.",
    ...
    {
      name: "Nightingale",
      desc: "The common nightingale or simply nightingale , also known as rufous nightingale, is a small passerine bird best known for its powerful and beautiful song. It was formerly classed as a member of the thrush family Turdidae, but is now more generally considered to be an Old World flycatcher, Muscicapidae.; It belongs to a group of more terrestrial species, often called chats.",
    ...
    {
      name: "Okapi",
      desc: "The okapi , also known as the forest giraffe, Congolese giraffe, or zebra giraffe, is an artiodactyl mammal native to the northeast of the Democratic Republic of the Congo in Central Africa. Although the okapi has striped markings reminiscent of zebras, it is most closely related to the giraffe. The okapi and the giraffe are the only living members of the family Giraffidae.",
    ...
    {
      name: "Opossum",
      desc: "The opossum is a marsupial of the order Didelphimorphia endemic to the Americas. The largest order of marsupials in the Western Hemisphere, it comprises 103 or more species in 19 genera. Opossums originated in South America and entered North America in the Great American Interchange following the connection of the two continents. Their unspecialized biology, flexible diet, and reproductive habits make them successful colonizers and survivors in diverse locations and conditions.;",
    ...
    {
      name: "Panther",
      desc: "A black panther is the melanistic colour variant of any Panthera species. Black panthers in Asia and Africa are leopards , and those in the Americas are jaguars.;",
    ...
    {
      name: "Partridge",
      desc: "Partridges are medium-sized non-migratory birds, with a wide native distribution throughout the Old World, including Europe, Asia, and parts of Africa. They are sometimes grouped in the Perdicinae subfamily of the Phasianidae. However, molecular research suggests that partridges are not a distinct taxon within the family Phasianidae, but that some species are closer to the pheasants, while others are closer to the junglefowl.;",
    ...
    {
      name: "Pheasant",
      desc: "Pheasants are birds of several genera within the subfamily Phasianinae, of the family Phasianidae in the order Galliformes. Though they can be found world over in introduced populations, the pheasant genera native range is restricted to Asia.",
    ...
    {
      name: "Pig",
      desc: "The domestic pig , often called swine, hog, or simply pig when there is no need to distinguish it from other pigs, is a domesticated large, even-toed ungulate. It is variously considered a subspecies of the Eurasian boar or a distinct species. The domestic pig's head-plus-body-length ranges from 0.9 to 1.8m , and adult pigs typically weigh between 50 and 350kg , with well-fed individuals often exceeding this weight range. The size and weight of a hog largely depends on its breed. Compared to other artiodactyls, its head is relatively long, pointed, and free of warts. Even-toed ungulates are generally herbivorous, but the domestic pig is an omnivore, like its wild relative.",
    ...
    {
      name: "Pika",
      desc: "A pika is a small mountain-dwelling mammal found in Asia and North America. With short limbs, very round body, and even coat of fur, and no external tail, they resemble their close cousin the rabbit, but with short rounded ears.; The large-eared pika of the Himalayas and nearby mountains is found at heights of more than 6,000 metres , among the highest of any mammal.",
    ...
    {
      name: "Polar bear",
      desc: "The polar bear is a hypercarnivorous bear whose native range lies largely within the Arctic Circle, encompassing the Arctic Ocean, its surrounding seas and surrounding land masses. It is a large bear, approximately the same size as the omnivorous Kodiak bear.; A boar weighs around 350-700kg ,; while a sow is about half that size. Polar bears are the largest land carnivores currently in existence, rivaled only by the Kodiak bear.; Although it is the sister species of the brown bear,; it has evolved to occupy a narrower ecological niche, with many body characteristics adapted for cold temperatures, for moving across snow, ice and open water, and for hunting seals, which make up most of its diet.; Although most polar bears are born on land, they spend most of their time on the sea ice. Their scientific name means 'maritime bear' and derives from this fact. Polar bears hunt their preferred food of seals from the edge of sea ice, often living off fat reserves when no sea ice is present. Because of their dependence on the sea ice, polar bears are classified as marine mammals.;",
    ...
    {
      name: "Quetzal",
      desc: "Quetzals are strikingly colored birds in the trogon family.",
    ...
    {
      name: "Raccoon",
      desc: "The raccoon , Procyon lotor), sometimes spelled racoon,; also known as the common raccoon,; North American raccoon,;, northern raccoon,; or coon, is a medium-sized mammal native to North America. The raccoon is the largest of the procyonid family, having a body length of 40 to 70cm and a body weight of 5 to 26kg.; Its grayish coat mostly consists of dense underfur which insulates it against cold weather. Three of the raccoon's most distinctive features are its extremely dexterous front paws, its facial mask, and its ringed tail, which are themes in the mythologies of the indigenous peoples of the Americas. Raccoons are noted for their intelligence, with studies showing that they are able to remember the solution to tasks for at least three years.; They are usually nocturnal and omnivorous, eating about 40% invertebrates, 33% plants, and 27% vertebrates.",
    ...
    {
      name: "Rat",
      desc: "Rats are various medium-sized, long-tailed rodents. Species of rats are found throughout the order Rodentia, but stereotypical rats are found in the genus Rattus. Other rat genera include Neotoma , Bandicota and Dipodomys.",
    ...
    {
      name: "Sand dollar",
      desc: "The term sand dollar refers to species of extremely flattened, burrowing sea urchins belonging to the order Clypeasteroida. Some species within the order, not quite as flat, are known as sea biscuits. ",
    ...
    {
      name: "Sardine",
      desc: "'Sardine' and 'pilchard' are common names used to refer to various small, oily fish in the herring family Clupeidae.; The term 'sardine' was first used in English during the early 15th century and may come from the Mediterranean island of Sardinia, around which sardines were once abundant.",
    ...
    {
      name: "Seal",
      desc: "Pinnipeds,; commonly known as seals,; are a widely distributed and diverse clade of carnivorous, fin-footed, semiaquatic marine mammals. They comprise the extant families Odobenidae , Otariidae , and Phocidae. There are 33 extant species of pinnipeds, and more than 50extinct species have been described from fossils. While seals were historically thought to have descended from two ancestral lines, molecular evidence supports them as a monophyletic lineage. Pinnipeds belong to the order Carnivora and their closest living relatives are believed to be bears and the superfamily of musteloids , having diverged about 50 million years ago.",
    ...
    {
      name: "Shrew",
      desc: "The shrew is a small mole-like mammal classified in the order Eulipotyphla. True shrews are not to be confused with treeshrews, otter shrews, elephant shrews, or the West Indies shrews, which belong to different families or orders.",
    ...
    {
      name: "Siamang",
      desc: "The siamang is an arboreal black-furred gibbon native to the forests of Indonesia, Malaysia and Thailand. The largest of the gibbons, the siamang can be twice the size of other gibbons, reaching 1 m in height, and weighing up to 14kg. The siamang is the only species in the genus Symphalangus.",
    ...
    {
      name: "Spider",
      desc: "Spiders are air-breathing arthropods that have eight legs and chelicerae with fangs able to inject venom. They are the largest order of arachnids and rank seventh in total species diversity among all orders of organisms.; Spiders are found worldwide on every continent except for Antarctica, and have become established in nearly every habitat with the exceptions of air and sea colonization. As of July2019;, at least 48,200 spider species, and 120 families have been recorded by taxonomists.; However, there has been dissension within the scientific community as to how all these families should be classified, as evidenced by the over 20 different classifications that have been proposed since 1900.;",
    ...
    {
      name: "Stegosaurus",
      desc: "Stegosaurus , from Greek stegos which means roof and sauros which means lizard , is a genus of herbivorous thyreophoran dinosaur. Fossils of this genus date to the Late Jurassic period, where they are found in Kimmeridgian to early Tithonian aged strata, between 155 and 150million years ago, in the western United States and Portugal. Of the species that have been classified in the upper Morrison Formation of the western US, only three are universally recognized; S. stenops, S. ungulatus and S. sulcatus. The remains of over 80 individual animals of this genus have been found. Stegosaurus would have lived alongside dinosaurs such as Apatosaurus, Diplodocus, Brachiosaurus, Allosaurus, and Ceratosaurus; the latter two may have been predators of it.",
    ...
    {
      name: "Tamarin",
      desc: "The tamarins are squirrel-sized New World monkeys from the family Callitrichidae in the genus Saguinus. They are the first offshoot in the Callitrichidae tree, and therefore are sister group of a clade formed by the lion tamarins, Goeldi's monkeys and marmosets.;",
    ...
    {
      name: "Tiger",
      desc: "The tiger is the largest species among the Felidae and classified in the genus Panthera. It is most recognisable for its dark vertical stripes on reddish-orange fur with a lighter underside. It is an apex predator, primarily preying on ungulates such as deer and wild boar. It is territorial and generally a solitary but social predator, requiring large contiguous areas of habitat, which support its requirements for prey and rearing of its offspring. Tiger cubs stay with their mother for about two years, before they become independent and leave their mother's home range to establish their own.",
    ...
    {
      name: "Toad",
      desc: "Toad is a common name for certain frogs, especially of the family Bufonidae, that are characterized by dry, leathery skin, short legs, and large bumps covering the parotoid glands.",
    ...
    {
      name: "Toucan",
      desc: "Toucans are members of the Neotropical near passerine bird family Ramphastidae. The Ramphastidae are most closely related to the American barbets. They are brightly marked and have large, often-colorful bills. The family includes five genera and over forty different species.",
    ...
    {
      name: "Turaco",
      desc: "The turacos make up the bird family Musophagidae , which includes plantain-eaters and go-away-birds. In southern Africa both turacos and go-away-birds are commonly known as loeries. They are semi-zygodactylous - the fourth toe can be switched back and forth. The second and third toes, which always point forward, are conjoined in some species. Musophagids often have prominent crests and long tails; the turacos are noted for peculiar and unique pigments giving them their bright green and red feathers.",
    ...
    {
      name: "Viper",
      desc: "The Viperidae are a family of venomous snakes found in most parts of the world, with the exception of Antarctica, Australia, Hawaii, Madagascar, New Zealand, various other isolated islands, and north of the Arctic Circle. All have relatively long, hinged fangs that permit deep penetration and injection of snake venom. Four subfamilies are currently recognized.; They are also known as viperids. The name 'viper' is derived from the Latin word vipera, -ae, also meaning viper, possibly from vivus  and parere , referring to the trait viviparity common in vipers but not in snakes at large.;",
    ...
    {
      name: "Whale",
      desc: "Whales are a widely distributed and diverse group of fully aquatic placental marine mammals. They are an informal grouping within the infraorder Cetacea, usually excluding dolphins and porpoises. Whales, dolphins and porpoises belong to the order Cetartiodactyla, which consists of even-toed ungulates. Their closest living relatives are the hippopotamuses, having diverged about 40 million years ago. The two parvorders of whales, baleen whales and toothed whales , are thought to have split apart around 34 million years ago. Whales consist of eight extant families: Balaenopteridae , Balaenidae , Cetotheriidae , Eschrichtiidae , Monodontidae , Physeteridae , Kogiidae , and Ziphiidae.",
    ...
    {
      name: "Wolf",
      desc: "The wolf , also known as the gray/grey wolf, timber wolf, or tundra wolf, is a canine native to the wilderness and remote areas of Eurasia and North America. It is the largest extant member of its family, with males averaging 43-45kg and females 36-38.5kg. It is distinguished from other Canis species by its larger size and less pointed features, particularly on the ears and muzzle. Its winter fur is long and bushy and predominantly a mottled gray in color, although nearly pure white, red and brown to black also occur. Mammal Species of the World , a standard reference work in zoology, recognises 38 subspecies of C. lupus.",
    ...
    {
      name: "Yak",
      desc: "The domestic yak is a long-haired domesticated bovid found throughout the Himalayan region of the Indian subcontinent, the Tibetan Plateau and as far north as Mongolia and Siberia. It is descended from the wild yak.;",
